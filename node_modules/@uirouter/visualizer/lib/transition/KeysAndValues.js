...
var KeyValueRow = /** @class */ (function (_super) {
    ...
    KeyValueRow.prototype.render = function () {
        ...
        var showModal = function () { return modal_1.Modal.show(modalTitle, key, val, ResolveData_1.ResolveData); };
        // prettier-ignore
...
var KeysAndValues = /** @class */ (function (_super) {
    ...
    KeysAndValues.prototype.render = function () {
        ...
        return (preact_1.h("div", { className: "uirTranVis_keysAndValues" },
            ...
            showGroupToggle &&
                !!groupedTuples.length && (preact_1.h("a", { href: "javascript:void(0)", onClick: function () { return _this.setState({ collapseFalsy: !isCollapsed }); }, className: "uirTranVis_keyValue" },
            ...
            (!showGroupToggle || !this.state.collapseFalsy) &&
                groupedTuples.map(function (tuple) { return (preact_1.h(KeyValueRow, { key: tuple.key, tuple: tuple, classes: classes, modalTitle: modalTitle })); })));
    };
