    ...
    StateTree.prototype.render = function () {
        ...
        return (preact_1.h("div", { className: "statevis" },
            preact_1.h("svg", { width: this.props.width, height: this.props.height },
                ...
                renderNodes.map(function (node) { return (preact_1.h(StateNode_1.StateNode, { key: node.name, node: node, router: _this.props.router, renderer: _this.props.renderer, doLayout: _this.doLayoutAnimation.bind(_this), x: node.animX, y: node.animY })); }))));
    };
