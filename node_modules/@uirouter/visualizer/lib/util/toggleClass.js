...
exports.hasClass = function (classname) { return function (el) { return !!new RegExp("\\b" + classname + "\\b").exec(el.className); }; };
exports.addClass = function (classname) { return function (el) { return (el.className = el.className + ' ' + classname); }; };
