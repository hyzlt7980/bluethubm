...
var StateSelector = /** @class */ (function (_super) {
    ...
    StateSelector.prototype.render = function () {
        return (h("select", { value: this.state.current || '', onChange: this.selectState, style: { maxWidth: 120 } },
            h("option", { value: "" }, "Choose a state"),
            this.state.states.map(function (state) { return (h("option", { key: state, value: state }, state)); })));
    };
