    ...
    StateTree.prototype.render = function () {
        ...
        return (h("div", { className: "statevis" },
            h("svg", { width: this.props.width, height: this.props.height },
                ...
                renderNodes.map(function (node) { return (h(StateNode, { key: node.name, node: node, router: _this.props.router, renderer: _this.props.renderer, doLayout: _this.doLayoutAnimation.bind(_this), x: node.animX, y: node.animY })); }))));
    };
